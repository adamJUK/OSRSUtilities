...
//import { MY_AUTH0_DOMAIN, MY_CLIENT_ID, MY_API_IDENTIFIER, MY_CALLBACK_URL } from '../../../backend/OSRSUtilities/extras.py'
...
export default class AuthService {
  ...
  auth0 = new auth0.WebAuth({
    domain: 'osrsutilities.eu.auth0.com',
    clientID: 'zEb9JM1kSPIGE4WsAYA2c46CtoXQIvgG',
